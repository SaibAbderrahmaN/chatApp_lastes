...
import {GroupFooter}from '../../components/Chat'
...
const ChatGroupComponent = ({ room }) => {
  ...
  return (
    ...
    >
      {/*  */}
      <GroupHeader />
      <Box width={"100%"} sx={{   position: "relative",   flexGrow: 1,   overflow: "scroll",  backgroundColor:     theme.palette.mode === "light"       ? "#F0F4FA"       : theme.palette.background,  boxShadow: "0px 0px 2px rgba(0, 0, 0, 0.25)", }} >
